...
import (
	...
	kinds "github.com/grafana/grafana-apiserver/pkg/client/informers/externalversions/kinds"
...
func (f *sharedInformerFactory) Kinds() kinds.Interface {
	return kinds.New(f, f.namespace, f.tweakListOptions)
}
