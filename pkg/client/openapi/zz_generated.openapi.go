...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinition":          schema_pkg_apis_kinds_v1_GrafanaResourceDefinition(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionCondition": schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionCondition(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionList":      schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionList(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionNames":     schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionNames(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionSpec":      schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionSpec(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionStatus":    schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionStatus(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionVersion":   schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionVersion(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceHistory":  schema_pkg_apis_kinds_v1_GrafanaResourceSubresourceHistory(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceRef":      schema_pkg_apis_kinds_v1_GrafanaResourceSubresourceRef(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceScale":    schema_pkg_apis_kinds_v1_GrafanaResourceSubresourceScale(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceStatus":   schema_pkg_apis_kinds_v1_GrafanaResourceSubresourceStatus(ref),
		"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresources":        schema_pkg_apis_kinds_v1_GrafanaResourceSubresources(ref),
...
func schema_pkg_apis_kinds_v1_GrafanaResourceDefinition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceDefinition represents a resource that should be exposed on the API server.  Its name MUST be in the format <.spec.name>.<.spec.group>.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "status indicates the actual state of the GrafanaResourceDefinition",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionSpec", "github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceDefinitionCondition contains details for the current condition of this pod.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceDefinitionList is a list of GrafanaResourceDefinition objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "items list individual GrafanaResourceDefinition objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinition", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionNames(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceDefinitionNames indicates the names to serve this GrafanaResourceDefinition",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"plural": {
						SchemaProps: spec.SchemaProps{
							Description: "plural is the plural name of the resource to serve. The custom resources are served under `/apis/<group>/<version>/.../<plural>`. Must match the name of the GrafanaResourceDefinition (in the form `<names.plural>.<group>`). Must be all lowercase.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceDefinitionSpec describes how a user wants their resource to appear",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"group": {
						SchemaProps: spec.SchemaProps{
							Description: "group is the API group of the defined custom resource. The custom resources are served under `/apis/<group>/...`. Must match the name of the GrafanaResourceDefinition (in the form `<names.plural>.<group>`).",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"names": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionNames"),
						},
					},
					"scope": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionVersion"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionNames", "github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionVersion"},
	}
}

func schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceDefinitionStatus indicates the state of the GrafanaResourceDefinition",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "conditions indicate state for particular aspects of a GrafanaResourceDefinition",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionCondition"),
									},
								},
							},
						},
					...
					"storedVersions": {
						SchemaProps: spec.SchemaProps{
							Description: "storedVersions lists all versions of GrafanaResources that were ever persisted. Tracking these versions allows a migration path for stored versions in etcd. The field is mutable so a migration controller can finish a migration to another version (ensuring no old objects are left in storage), and then remove the rest of the versions from this list. Versions may not be removed from `spec.versions` while they exist in this list.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionCondition", "github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceDefinitionNames"},
	}
}

func schema_pkg_apis_kinds_v1_GrafanaResourceDefinitionVersion(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceDefinitionVersion describes a version for GRD.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
					...
					"subresources": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresources"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresources"},
	}
}

func schema_pkg_apis_kinds_v1_GrafanaResourceSubresourceHistory(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_kinds_v1_GrafanaResourceSubresourceRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_kinds_v1_GrafanaResourceSubresourceScale(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceSubresourceScale defines how to serve the scale subresource for GrafanaResources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"specReplicasPath": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_kinds_v1_GrafanaResourceSubresources(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GrafanaResourceSubresources defines the status and scale subresources for GrafanaResources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "status indicates the custom resource should serve a `/status` subresource. When enabled: 1. requests to the custom resource primary endpoint ignore changes to the `status` stanza of the object. 2. requests to the custom resource `/status` subresource ignore changes to anything other than the `status` stanza of the object.",
							Ref:         ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceStatus"),
						},
					},
					"scale": {
						SchemaProps: spec.SchemaProps{
							Description: "scale indicates the custom resource should serve a `/scale` subresource that returns an `autoscaling/v1` Scale object.",
							Ref:         ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceScale"),
						},
					},
					"history": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceHistory"),
						},
					},
					"ref": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceRef"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceHistory", "github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceRef", "github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceScale", "github.com/grafana/grafana-apiserver/pkg/apis/kinds/v1.GrafanaResourceSubresourceStatus"},
	}
}
